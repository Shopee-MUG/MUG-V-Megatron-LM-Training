...
# - Scale-shift table for adaptive layer normalization (AdaLN) in diffusion transformers
# - Variable sequence length handling for pipeline parallelism
...
from megatron.core.transformer.transformer_layer import BaseTransformerLayer, TransformerLayerSubmodules
...
class TransformerLayer(MegatronModule, BaseTransformerLayer):
    ...
    def __init__(
        ...
        # TODO: We initialize scale shift table here for avoid comm overlapping and checkpointing bug,
        # We will move it back to the mugdit layer class once we fix this bug.
