...
export LOAD_NAME=10B_new
export MODEL_TYPE=${MODEL_TYPE:-"mugdit_debug"}

SOURCE=$(pwd)
AIP_TAG="${AIP_RUN_ID:-local}-${AIP_RUN_NAME:-run}"
MODEL_NAME="${AIP_TAG}-${MODEL_TYPE}-$(basename ${SOURCE})"
...
# PRETRAINED_TASK_ID=442268-d296-10b-percentile-b-aip-mcore-mugdit
